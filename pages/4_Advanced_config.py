...
url_demo = "https://ukrbublik.github.io/react-awesome-query-builder/"
url_demo_config = "https://github.com/ukrbublik/react-awesome-query-builder/blob/master/packages/examples/demo/config.tsx"
url_config_doc = "https://github.com/ukrbublik/react-awesome-query-builder/blob/master/CONFIG.adoc"

st.markdown("""
This page shows an example of advanced configuration.
This example is inspired from the original component live demo [link](%s), which configuration can be found [here](%s).
You can access the configuration full documentation [here](%s).

Javascript code can be injected to define custom field / value functions or validation functions.
It must be wrapped into a JsCode object.

""" % (url_demo, url_demo_config, url_config_doc),)
